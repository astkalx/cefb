...
lappend arg_list "--report-file=csv:C5_DDR3_example.csv"
lappend arg_list "--report-file=qip:C5_DDR3_example.qip"
lappend arg_list "--output-name=C5_DDR3_example"
...
lappend arg_list "--component-param=MEM_CLK_FREQ=533.0"
...
lappend arg_list "--component-param=MEM_RTT_NOM=RZQ/4"
...
lappend arg_list "--component-param=REF_CLK_FREQ=25.0"
...
catch { eval [concat [list exec "/opt/intelFPGA/16.1/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_ddr3_tg_ed] $arg_list] } temp
puts $temp
