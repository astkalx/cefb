...
lappend arg_list "--component-param=MEM_TINIT_CK=266500"
...
lappend arg_list "--component-param=SEQ_ROM=C5_DDR3_example_if0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=C5_DDR3_example_if0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=C5_DDR3_example_if0_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=AVL_CLK_PS=13125"
lappend arg_list "--component-param=AFI_CLK_PS=1875"
...
lappend arg_list "--output-name=C5_DDR3_example_if0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:C5_DDR3_example_if0_s0.sopcinfo"
lappend arg_list "--report-file=txt:C5_DDR3_example_if0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "/usr/opt/intelFPGA/16.1/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
