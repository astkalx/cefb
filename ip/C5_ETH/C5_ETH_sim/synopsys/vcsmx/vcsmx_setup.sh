...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/altera_eth_tse_mac/synopsys/altera_eth_tse_ptp_std_synchronizer.v"    -work i_tse_mac
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/C5_ETH.v"                                                                            
fi
